...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename fft_im_1 \
    op interface \
    ports { fft_im_1_address0 { O 10 vector } fft_im_1_ce0 { O 1 bit } fft_im_1_we0 { O 1 bit } fft_im_1_d0 { O 16 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename fft_im \
    op interface \
    ports { fft_im_address0 { O 10 vector } fft_im_ce0 { O 1 bit } fft_im_we0 { O 1 bit } fft_im_d0 { O 16 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename fft_re_1 \
    op interface \
    ports { fft_re_1_address0 { O 10 vector } fft_re_1_ce0 { O 1 bit } fft_re_1_we0 { O 1 bit } fft_re_1_d0 { O 16 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename fft_re \
    op interface \
    ports { fft_re_address0 { O 10 vector } fft_re_ce0 { O 1 bit } fft_re_we0 { O 1 bit } fft_re_d0 { O 16 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { fft_in_0_TVALID { I 1 bit } fft_in_0_TDATA { I 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { fft_in_0_TREADY { O 1 bit } fft_in_0_TLAST { I 1 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { fft_in_1_TVALID { I 1 bit } fft_in_1_TDATA { I 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { fft_in_1_TREADY { O 1 bit } fft_in_1_TLAST { I 1 vector } } \
} "
} else {
