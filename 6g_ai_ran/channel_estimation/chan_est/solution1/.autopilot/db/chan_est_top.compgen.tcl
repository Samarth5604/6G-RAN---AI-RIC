...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler chan_est_top_fft_re_RAM_AUTO_1R1W BINDTYPE {storage} TYPE {ram} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler chan_est_top_pilot_h_re_RAM_AUTO_1R1W BINDTYPE {storage} TYPE {ram} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { weight_stream_TDATA { O 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { weight_stream_TVALID { O 1 bit } weight_stream_TREADY { I 1 bit } weight_stream_TLAST { O 1 vector } } \
} "
} else {
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler chan_est_top_regslice_both BINDTYPE {interface} TYPE {adapter} IMPL {reg_slice}
}
