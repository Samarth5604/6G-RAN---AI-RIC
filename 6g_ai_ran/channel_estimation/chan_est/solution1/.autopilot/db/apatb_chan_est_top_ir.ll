; ModuleID = '/home/samarth/Desktop/6g_ai_ran/channel_estimation/chan_est/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_chan_est_top_ir(%"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* noalias nonnull "fpga.decayed.dim.hint"="2" %fft_in, %"struct.ap_uint<4>"* nocapture readonly %symbol_num, %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* noalias nonnull dereferenceable(12) %weight_stream) local_unnamed_addr #0 {
entry:
  ...
  call void @copy_in([2 x %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"]* nonnull %0, i32* nonnull align 512 %fft_in_copy_0.data, i4* nonnull align 512 %fft_in_copy_0.keep, i4* nonnull align 512 %fft_in_copy_0.strb, i1* nonnull align 512 %fft_in_copy_0.last, i32* nonnull align 512 %fft_in_copy_1.data, i4* nonnull align 512 %fft_in_copy_1.keep, i4* nonnull align 512 %fft_in_copy_1.strb, i1* nonnull align 512 %fft_in_copy_1.last, %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* nonnull %weight_stream, i32* nonnull align 512 %weight_stream_copy.data, i4* nonnull align 512 %weight_stream_copy.keep, i4* nonnull align 512 %weight_stream_copy.strb, i1* nonnull align 512 %weight_stream_copy.last)
  call void @apatb_chan_est_top_hw(i32* %fft_in_copy_0.data, i4* %fft_in_copy_0.keep, i4* %fft_in_copy_0.strb, i1* %fft_in_copy_0.last, i32* %fft_in_copy_1.data, i4* %fft_in_copy_1.keep, i4* %fft_in_copy_1.strb, i1* %fft_in_copy_1.last, %"struct.ap_uint<4>"* %symbol_num, i32* %weight_stream_copy.data, i4* %weight_stream_copy.keep, i4* %weight_stream_copy.strb, i1* %weight_stream_copy.last)
  call void @copy_back([2 x %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"]* %0, i32* %fft_in_copy_0.data, i4* %fft_in_copy_0.keep, i4* %fft_in_copy_0.strb, i1* %fft_in_copy_0.last, i32* %fft_in_copy_1.data, i4* %fft_in_copy_1.keep, i4* %fft_in_copy_1.strb, i1* %fft_in_copy_1.last, %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* %weight_stream, i32* %weight_stream_copy.data, i4* %weight_stream_copy.keep, i4* %weight_stream_copy.strb, i1* %weight_stream_copy.last)
  ret void
}
...
copy:                                             ; preds = %entry
  call fastcc void @"streamcpy_hls.p0class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>.30"(i32* align 512 %dst_V_data_V, i4* align 512 %dst_V_keep_V, i4* align 512 %dst_V_strb_V, i1* align 512 %dst_V_last_V, %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* nonnull %src)
  br label %ret
...
dst.addr.case.0:                                  ; preds = %for.loop
  call void @"streamcpy_hls.p0class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>.30"(i32* %dst_0_V_data_V, i4* %dst_0_V_keep_V, i4* %dst_0_V_strb_V, i1* %dst_0_V_last_V, %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* %src.addr)
  br label %dst.addr.exit

dst.addr.case.1:                                  ; preds = %for.loop
  %1 = icmp eq i64 %for.loop.idx2, 1
  call void @llvm.assume(i1 %1)
  call void @"streamcpy_hls.p0class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>.30"(i32* %dst_1_V_data_V, i4* %dst_1_V_keep_V, i4* %dst_1_V_strb_V, i1* %dst_1_V_last_V, %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* %src.addr)
  br label %dst.addr.exit
...
; Function Attrs: argmemonly noinline willreturn
define void @"arraycpy_hls.p0a2class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>.14.15"([2 x %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"]* "orig.arg.no"="0" %dst, i32* "orig.arg.no"="1" "unpacked"="1.0.0" %src_0_V_data_V, i4* "orig.arg.no"="1" "unpacked"="1.0.1" %src_0_V_keep_V, i4* "orig.arg.no"="1" "unpacked"="1.0.2" %src_0_V_strb_V, i1* "orig.arg.no"="1" "unpacked"="1.0.3" %src_0_V_last_V, i32* "orig.arg.no"="1" "unpacked"="1.1.0" %src_1_V_data_V, i4* "orig.arg.no"="1" "unpacked"="1.1.1" %src_1_V_keep_V, i4* "orig.arg.no"="1" "unpacked"="1.1.2" %src_1_V_strb_V, i1* "orig.arg.no"="1" "unpacked"="1.1.3" %src_1_V_last_V, i64 "orig.arg.no"="2" %num) #1 {
entry:
...
src.addr.case.0:                                  ; preds = %for.loop
  call void @"streamcpy_hls.p0class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>.24"(%"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* %dst.addr, i32* %src_0_V_data_V, i4* %src_0_V_keep_V, i4* %src_0_V_strb_V, i1* %src_0_V_last_V)
  br label %src.addr.exit

src.addr.case.1:                                  ; preds = %for.loop
  %1 = icmp eq i64 %for.loop.idx2, 1
  call void @llvm.assume(i1 %1)
  call void @"streamcpy_hls.p0class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>.24"(%"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* %dst.addr, i32* %src_1_V_data_V, i4* %src_1_V_keep_V, i4* %src_1_V_strb_V, i1* %src_1_V_last_V)
  br label %src.addr.exit
...
; Function Attrs: argmemonly noinline willreturn
define internal void @"onebyonecpy_hls.p0a2class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>.13.16"([2 x %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"]* noalias "orig.arg.no"="0" %dst, i32* noalias align 512 "orig.arg.no"="1" "unpacked"="1.0.0" %src_0_V_data_V, i4* noalias align 512 "orig.arg.no"="1" "unpacked"="1.0.1" %src_0_V_keep_V, i4* noalias align 512 "orig.arg.no"="1" "unpacked"="1.0.2" %src_0_V_strb_V, i1* noalias align 512 "orig.arg.no"="1" "unpacked"="1.0.3" %src_0_V_last_V, i32* noalias align 512 "orig.arg.no"="1" "unpacked"="1.1.0" %src_1_V_data_V, i4* noalias align 512 "orig.arg.no"="1" "unpacked"="1.1.1" %src_1_V_keep_V, i4* noalias align 512 "orig.arg.no"="1" "unpacked"="1.1.2" %src_1_V_strb_V, i1* noalias align 512 "orig.arg.no"="1" "unpacked"="1.1.3" %src_1_V_last_V) #3 {
entry:
  %0 = icmp eq [2 x %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"]* %dst, null
  br i1 %0, label %ret, label %copy

copy:                                             ; preds = %entry
  call void @"arraycpy_hls.p0a2class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>.14.15"([2 x %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"]* nonnull %dst, i32* %src_0_V_data_V, i4* %src_0_V_keep_V, i4* %src_0_V_strb_V, i1* %src_0_V_last_V, i32* %src_1_V_data_V, i4* %src_1_V_keep_V, i4* %src_1_V_strb_V, i1* %src_1_V_last_V, i64 2)
  br label %ret
...
; Function Attrs: argmemonly noinline willreturn
define internal void @copy_out([2 x %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"]* noalias "orig.arg.no"="0", i32* noalias align 512 "orig.arg.no"="1" "unpacked"="1.0.0" %_0_V_data_V, i4* noalias align 512 "orig.arg.no"="1" "unpacked"="1.0.1" %_0_V_keep_V, i4* noalias align 512 "orig.arg.no"="1" "unpacked"="1.0.2" %_0_V_strb_V, i1* noalias align 512 "orig.arg.no"="1" "unpacked"="1.0.3" %_0_V_last_V, i32* noalias align 512 "orig.arg.no"="1" "unpacked"="1.1.0" %_1_V_data_V, i4* noalias align 512 "orig.arg.no"="1" "unpacked"="1.1.1" %_1_V_keep_V, i4* noalias align 512 "orig.arg.no"="1" "unpacked"="1.1.2" %_1_V_strb_V, i1* noalias align 512 "orig.arg.no"="1" "unpacked"="1.1.3" %_1_V_last_V, %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* noalias "orig.arg.no"="2", i32* noalias align 512 "orig.arg.no"="3" "unpacked"="4.0" %_V_data_V, i4* noalias align 512 "orig.arg.no"="3" "unpacked"="4.1" %_V_keep_V, i4* noalias align 512 "orig.arg.no"="3" "unpacked"="4.2" %_V_strb_V, i1* noalias align 512 "orig.arg.no"="3" "unpacked"="4.3" %_V_last_V) #6 {
entry:
  call void @"onebyonecpy_hls.p0a2class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>.13.16"([2 x %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"]* %0, i32* align 512 %_0_V_data_V, i4* align 512 %_0_V_keep_V, i4* align 512 %_0_V_strb_V, i1* align 512 %_0_V_last_V, i32* align 512 %_1_V_data_V, i4* align 512 %_1_V_keep_V, i4* align 512 %_1_V_strb_V, i1* align 512 %_1_V_last_V)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>.21"(%"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* %1, i32* align 512 %_V_data_V, i4* align 512 %_V_keep_V, i4* align 512 %_V_strb_V, i1* align 512 %_V_last_V)
  ret void
}

; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>.21"(%"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* noalias %dst, i32* noalias align 512 "unpacked"="1.0" %src_V_data_V, i4* noalias align 512 "unpacked"="1.1" %src_V_keep_V, i4* noalias align 512 "unpacked"="1.2" %src_V_strb_V, i1* noalias align 512 "unpacked"="1.3" %src_V_last_V) unnamed_addr #3 {
entry:
  %0 = icmp eq %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* %dst, null
  br i1 %0, label %ret, label %copy

copy:                                             ; preds = %entry
  call fastcc void @"streamcpy_hls.p0class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>.24"(%"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* nonnull %dst, i32* align 512 %src_V_data_V, i4* align 512 %src_V_keep_V, i4* align 512 %src_V_strb_V, i1* align 512 %src_V_last_V)
  br label %ret
...
; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @"streamcpy_hls.p0class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>.24"(%"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* nocapture, i32* nocapture "unpacked"="1.0" %_V_data_V, i4* nocapture "unpacked"="1.1" %_V_keep_V, i4* nocapture "unpacked"="1.2" %_V_strb_V, i1* nocapture "unpacked"="1.3" %_V_last_V) unnamed_addr #2 {
entry:
  %1 = alloca i32
  %2 = alloca i4
  %3 = alloca i4
...
; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @"streamcpy_hls.p0class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>.30"(i32* nocapture "unpacked"="0.0" %_V_data_V, i4* nocapture "unpacked"="0.1" %_V_keep_V, i4* nocapture "unpacked"="0.2" %_V_strb_V, i1* nocapture "unpacked"="0.3" %_V_last_V, %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* nocapture) unnamed_addr #2 {
entry:
...
declare void @apatb_chan_est_top_hw(i32*, i4*, i4*, i1*, i32*, i4*, i4*, i1*, %"struct.ap_uint<4>"*, i32*, i4*, i4*, i1*)
...
define void @chan_est_top_hw_stub_wrapper(i32*, i4*, i4*, i1*, i32*, i4*, i4*, i1*, %"struct.ap_uint<4>"*, i32*, i4*, i4*, i1*) #7 {
entry:
  %13 = alloca [2 x %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"]
  %14 = alloca %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"
  call void @copy_out([2 x %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"]* %13, i32* %0, i4* %1, i4* %2, i1* %3, i32* %4, i4* %5, i4* %6, i1* %7, %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* %14, i32* %9, i4* %10, i4* %11, i1* %12)
  %15 = bitcast [2 x %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"]* %13 to %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"*
  call void @chan_est_top_hw_stub(%"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* %15, %"struct.ap_uint<4>"* %8, %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* %14)
  call void @copy_in([2 x %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"]* %13, i32* %0, i4* %1, i4* %2, i1* %3, i32* %4, i4* %5, i4* %6, i1* %7, %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* %14, i32* %9, i4* %10, i4* %11, i1* %12)
  ret void
}

declare void @chan_est_top_hw_stub(%"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* noalias nonnull, %"struct.ap_uint<4>"* nocapture readonly, %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* noalias nonnull)
