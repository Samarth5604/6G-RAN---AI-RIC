...
module chan_est_top_hls_deadlock_idx0_monitor ( // for module chan_est_top_chan_est_top_inst
    input wire clock,
    input wire reset,
...
// instant sub module
 chan_est_top_hls_deadlock_idx1_monitor chan_est_top_hls_deadlock_idx1_monitor_U (
    .clock(clock),
    .reset(reset),
