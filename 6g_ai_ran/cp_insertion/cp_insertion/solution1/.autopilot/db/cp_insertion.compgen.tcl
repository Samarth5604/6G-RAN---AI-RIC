...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler cp_insertion_buf_data_RAM_AUTO_1R1W BINDTYPE {storage} TYPE {ram} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler cp_insertion_buf_strb_RAM_AUTO_1R1W BINDTYPE {storage} TYPE {ram} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler cp_insertion_regslice_both BINDTYPE {interface} TYPE {adapter} IMPL {reg_slice}
}
