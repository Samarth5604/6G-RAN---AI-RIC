...
HD_PWD='/home/samarth/Desktop/6g_ai_ran/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log thz_pipeline_top_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source thz_pipeline_top_wrapper.tcl
