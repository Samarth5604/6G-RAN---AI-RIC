set moduleName snr_monitor_top_Pipeline_weight_drain
set isTopModule 0
...
set C_modelName {snr_monitor_top_Pipeline_weight_drain}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict h_re { MEM_WIDTH 16 MEM_SIZE 2048 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
dict set ap_memory_interface_dict h_im { MEM_WIDTH 16 MEM_SIZE 2048 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
	...
	{ h_re int 16 regular {array 1024 { 0 3 } 0 1 }  }
	{ h_im int 16 regular {array 1024 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "weight_stream_V_data_V", "interface" : "axis", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "h_re", "interface" : "memory", "bitwidth" : 16, "direction" : "WRITEONLY"} , 
 	{ "Name" : "h_im", "interface" : "memory", "bitwidth" : 16, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ weight_stream_TDATA sc_in sc_lv 32 signal 0 } 
	{ weight_stream_TREADY sc_out sc_logic 1 inacc 3 } 
	{ weight_stream_TKEEP sc_in sc_lv 4 signal 1 } 
	{ weight_stream_TSTRB sc_in sc_lv 4 signal 2 } 
	{ weight_stream_TLAST sc_in sc_lv 1 signal 3 } 
	{ h_re_address0 sc_out sc_lv 10 signal 4 } 
	{ h_re_ce0 sc_out sc_logic 1 signal 4 } 
	{ h_re_we0 sc_out sc_logic 1 signal 4 } 
	{ h_re_d0 sc_out sc_lv 16 signal 4 } 
	{ h_im_address0 sc_out sc_lv 10 signal 5 } 
	{ h_im_ce0 sc_out sc_logic 1 signal 5 } 
	{ h_im_we0 sc_out sc_logic 1 signal 5 } 
	{ h_im_d0 sc_out sc_lv 16 signal 5 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "h_re_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "h_re", "role": "we0" }} , 
 	{ "name": "h_re_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "h_re", "role": "d0" }} , 
 	...
 	{ "name": "h_im_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "h_im", "role": "we0" }} , 
 	{ "name": "h_im_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "h_im", "role": "d0" }}  ]}
...
set Spec2ImplPortList { 
	...
	h_re { ap_memory {  { h_re_address0 mem_address 1 10 }  { h_re_ce0 mem_ce 1 1 }  { h_re_we0 mem_we 1 1 }  { h_re_d0 mem_din 1 16 } } }
	h_im { ap_memory {  { h_im_address0 mem_address 1 10 }  { h_im_ce0 mem_ce 1 1 }  { h_im_we0 mem_we 1 1 }  { h_im_d0 mem_din 1 16 } } }
}
