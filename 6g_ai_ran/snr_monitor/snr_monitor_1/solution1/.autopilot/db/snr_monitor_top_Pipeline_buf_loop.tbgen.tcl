set moduleName snr_monitor_top_Pipeline_buf_loop
set isTopModule 0
...
set C_modelName {snr_monitor_top_Pipeline_buf_loop}
...
set portList { 
	...
	{ fft_in_0_TVALID sc_in sc_logic 1 invld 0 } 
	{ fft_in_1_TVALID sc_in sc_logic 1 invld 6 } 
	...
	{ fft_re_we0 sc_out sc_logic 1 signal 4 } 
	{ fft_re_d0 sc_out sc_lv 16 signal 4 } 
	{ fft_im_address0 sc_out sc_lv 10 signal 5 } 
	{ fft_im_ce0 sc_out sc_logic 1 signal 5 } 
	{ fft_im_we0 sc_out sc_logic 1 signal 5 } 
	{ fft_im_d0 sc_out sc_lv 16 signal 5 } 
	{ fft_in_1_TDATA sc_in sc_lv 32 signal 6 } 
	{ fft_in_1_TREADY sc_out sc_logic 1 inacc 9 } 
	{ fft_in_1_TKEEP sc_in sc_lv 4 signal 7 } 
	{ fft_in_1_TSTRB sc_in sc_lv 4 signal 8 } 
	{ fft_in_1_TLAST sc_in sc_lv 1 signal 9 } 
}
set NewPortList {[ 
