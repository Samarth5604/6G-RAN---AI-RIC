...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename h_re \
    op interface \
    ports { h_re_address0 { O 10 vector } h_re_ce0 { O 1 bit } h_re_we0 { O 1 bit } h_re_d0 { O 16 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'h_re'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename h_im \
    op interface \
    ports { h_im_address0 { O 10 vector } h_im_ce0 { O 1 bit } h_im_we0 { O 1 bit } h_im_d0 { O 16 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'h_im'"
}
}
