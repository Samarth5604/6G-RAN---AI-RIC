...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("symbol_num", 4, hls_out, 0, "ap_none", "out_data", 1),
	Port_Property("slot_num", 7, hls_out, 1, "ap_none", "out_data", 1),
	Port_Property("gpio_override", 1, hls_in, 2, "ap_none", "in_data", 1),
	Port_Property("gpio_symbol_num", 4, hls_in, 3, "ap_none", "in_data", 1),
	Port_Property("gpio_slot_num", 7, hls_in, 4, "ap_none", "in_data", 1),
...
const char* HLS_Design_Meta::dut_name = "slot_counter_top";
