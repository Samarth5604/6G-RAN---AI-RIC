...
always @ (*) begin
    if (((1'b0 == ap_block_state1) & (1'b1 == ap_CS_fsm_state1))) begin
        mode_c_write_local = 1'b1;
    end else begin
        mode_c_write_local = 1'b0;
    end
end
...
assign mode_c_write = mode_c_write_local;

assign start_out = real_start;

endmodule //mlkem_top_entry_proc
