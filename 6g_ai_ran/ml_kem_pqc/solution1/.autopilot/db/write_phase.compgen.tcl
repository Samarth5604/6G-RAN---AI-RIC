...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { result_stream_dout { I 16 vector } result_stream_num_data_valid { I 9 vector } result_stream_fifo_cap { I 9 vector } result_stream_empty_n { I 1 bit } result_stream_read { O 1 bit } } \
} "
}
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler mlkem_top_regslice_both BINDTYPE {interface} TYPE {adapter} IMPL {reg_slice}
}
...
set InstName mlkem_top_flow_control_loop_pipe_U
set CompName mlkem_top_flow_control_loop_pipe
