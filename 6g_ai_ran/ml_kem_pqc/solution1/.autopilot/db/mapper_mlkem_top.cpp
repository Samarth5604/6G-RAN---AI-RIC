...
auto* sout_stream_V_last_V = createStream((hls::stream<char>*)__xlx_apatb_param_out_stream_V_last_V);
  // DUT call
  mlkem_top(__xlx_apatb_param_mode, sin_stream_V_data_V->data<int>(), sin_stream_V_keep_V->data<char>(), sin_stream_V_strb_V->data<char>(), sin_stream_V_last_V->data<char>(), sout_stream_V_data_V->data<int>(), sout_stream_V_keep_V->data<char>(), sout_stream_V_strb_V->data<char>(), sout_stream_V_last_V->data<char>());
