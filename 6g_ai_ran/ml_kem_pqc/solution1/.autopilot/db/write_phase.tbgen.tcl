...
set C_modelName {write_phase}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ result_stream int 16 regular {fifo 0 volatile }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "result_stream", "interface" : "fifo", "bitwidth" : 16, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ result_stream_dout sc_in sc_lv 16 signal 0 } 
	{ result_stream_num_data_valid sc_in sc_lv 9 signal 0 } 
	{ result_stream_fifo_cap sc_in sc_lv 9 signal 0 } 
	{ result_stream_empty_n sc_in sc_logic 1 signal 0 } 
	{ result_stream_read sc_out sc_logic 1 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "result_stream_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "result_stream", "role": "dout" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "5"],
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "result_stream", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "256", "DependentChanType" : "0",
				"BlockSignal" : [
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_out_stream_V_data_V_U", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_out_stream_V_keep_V_U", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_out_stream_V_strb_V_U", "Parent" : "0"},
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_out_stream_V_last_V_U", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	result_stream { ap_fifo {  { result_stream_dout fifo_data_in 0 16 }  { result_stream_num_data_valid fifo_status_num_data_valid 0 9 }  { result_stream_fifo_cap fifo_update 0 9 }  { result_stream_empty_n fifo_status 0 1 }  { result_stream_read fifo_port_we 1 1 } } }
