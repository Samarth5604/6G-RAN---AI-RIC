...
entity mlkem_top_fifo_w32_d3_S is 
    generic (
...
architecture rtl of mlkem_top_fifo_w32_d3_S is
------------------------Task and function--------------
------------------------Parameter----------------------
constant SRL_DEPTH  : INTEGER := DEPTH;
constant SRL_AWIDTH : INTEGER := ADDR_WIDTH;
------------------------Component----------------------
    component mlkem_top_fifo_w32_d3_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 32;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 3);
...
begin
----------------------- Instantiation -----------------------
    U_mlkem_top_fifo_w32_d3_S_ShiftReg : mlkem_top_fifo_w32_d3_S_ShiftReg
    generic map (
...
entity mlkem_top_fifo_w32_d3_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 32;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 3);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end mlkem_top_fifo_w32_d3_S_ShiftReg;

architecture rtl of mlkem_top_fifo_w32_d3_S_ShiftReg is
