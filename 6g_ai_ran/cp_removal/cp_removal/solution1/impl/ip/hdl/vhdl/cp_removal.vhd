...
architecture behav of cp_removal is 
    ...
    signal grp_cp_removal_Pipeline_cp_discard_fu_52_ap_start : STD_LOGIC;
    signal grp_cp_removal_Pipeline_cp_discard_fu_52_ap_done : STD_LOGIC;
    signal grp_cp_removal_Pipeline_cp_discard_fu_52_ap_idle : STD_LOGIC;
    signal grp_cp_removal_Pipeline_cp_discard_fu_52_ap_ready : STD_LOGIC;
    signal grp_cp_removal_Pipeline_cp_discard_fu_52_in_stream_TREADY : STD_LOGIC;
    signal grp_cp_removal_Pipeline_cp_forward_fu_64_ap_start : STD_LOGIC;
    signal grp_cp_removal_Pipeline_cp_forward_fu_64_ap_done : STD_LOGIC;
    signal grp_cp_removal_Pipeline_cp_forward_fu_64_ap_idle : STD_LOGIC;
    signal grp_cp_removal_Pipeline_cp_forward_fu_64_ap_ready : STD_LOGIC;
    signal grp_cp_removal_Pipeline_cp_forward_fu_64_out_stream_TREADY : STD_LOGIC;
    signal grp_cp_removal_Pipeline_cp_forward_fu_64_in_stream_TREADY : STD_LOGIC;
    signal grp_cp_removal_Pipeline_cp_forward_fu_64_out_stream_TDATA : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_cp_removal_Pipeline_cp_forward_fu_64_out_stream_TVALID : STD_LOGIC;
    signal grp_cp_removal_Pipeline_cp_forward_fu_64_out_stream_TKEEP : STD_LOGIC_VECTOR (3 downto 0);
    signal grp_cp_removal_Pipeline_cp_forward_fu_64_out_stream_TSTRB : STD_LOGIC_VECTOR (3 downto 0);
    signal grp_cp_removal_Pipeline_cp_forward_fu_64_out_stream_TLAST : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_cp_removal_Pipeline_cp_discard_fu_52_ap_start_reg : STD_LOGIC := '0';
    signal ap_CS_fsm_state2 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state2 : signal is "none";
    signal ap_CS_fsm_state3 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state3 : signal is "none";
    signal grp_cp_removal_Pipeline_cp_forward_fu_64_ap_start_reg : STD_LOGIC := '0';
    ...
    component cp_removal_cp_removal_Pipeline_cp_discard IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component cp_removal_cp_removal_Pipeline_cp_forward IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component cp_removal_regslice_both IS
    generic (
        DataWidth : INTEGER );
    port (
        ap_clk : IN STD_LOGIC;
...
begin
    grp_cp_removal_Pipeline_cp_discard_fu_52 : component cp_removal_cp_removal_Pipeline_cp_discard
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    grp_cp_removal_Pipeline_cp_forward_fu_64 : component cp_removal_cp_removal_Pipeline_cp_forward
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    regslice_both_in_stream_V_data_V_U : component cp_removal_regslice_both
    generic map (
        DataWidth => 32)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_in_stream_V_keep_V_U : component cp_removal_regslice_both
    generic map (
        DataWidth => 4)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_in_stream_V_strb_V_U : component cp_removal_regslice_both
    generic map (
        DataWidth => 4)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_in_stream_V_last_V_U : component cp_removal_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_out_stream_V_data_V_U : component cp_removal_regslice_both
    generic map (
        DataWidth => 32)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_out_stream_V_keep_V_U : component cp_removal_regslice_both
    generic map (
        DataWidth => 4)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_out_stream_V_strb_V_U : component cp_removal_regslice_both
    generic map (
        DataWidth => 4)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_out_stream_V_last_V_U : component cp_removal_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    grp_cp_removal_Pipeline_cp_discard_fu_52_ap_start_reg_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                grp_cp_removal_Pipeline_cp_discard_fu_52_ap_start_reg <= ap_const_logic_0;
            else
                if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
                    grp_cp_removal_Pipeline_cp_discard_fu_52_ap_start_reg <= ap_const_logic_1;
                elsif ((grp_cp_removal_Pipeline_cp_discard_fu_52_ap_ready = ap_const_logic_1)) then 
                    grp_cp_removal_Pipeline_cp_discard_fu_52_ap_start_reg <= ap_const_logic_0;
                end if; 
            end if;
        end if;
    ...
    grp_cp_removal_Pipeline_cp_forward_fu_64_ap_start_reg_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                grp_cp_removal_Pipeline_cp_forward_fu_64_ap_start_reg <= ap_const_logic_0;
            else
                if ((ap_const_logic_1 = ap_CS_fsm_state5)) then 
                    grp_cp_removal_Pipeline_cp_forward_fu_64_ap_start_reg <= ap_const_logic_1;
                elsif ((grp_cp_removal_Pipeline_cp_forward_fu_64_ap_ready = ap_const_logic_1)) then 
                    grp_cp_removal_Pipeline_cp_forward_fu_64_ap_start_reg <= ap_const_logic_0;
                end if; 
            end if;
        end if;
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, grp_cp_removal_Pipeline_cp_discard_fu_52_ap_done, grp_cp_removal_Pipeline_cp_forward_fu_64_ap_done, ap_CS_fsm_state3, ap_CS_fsm_state6, ap_CS_fsm_state7, regslice_both_out_stream_V_data_V_U_apdone_blk)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state3 => 
                if (((grp_cp_removal_Pipeline_cp_discard_fu_52_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state3))) then
            ...
            when ap_ST_fsm_state6 => 
                if (((grp_cp_removal_Pipeline_cp_forward_fu_64_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state6))) then
    ...
    ap_ST_fsm_state3_blk_assign_proc : process(grp_cp_removal_Pipeline_cp_discard_fu_52_ap_done)
    begin
        if ((grp_cp_removal_Pipeline_cp_discard_fu_52_ap_done = ap_const_logic_0)) then 
    ...
    ap_ST_fsm_state6_blk_assign_proc : process(grp_cp_removal_Pipeline_cp_forward_fu_64_ap_done)
    begin
        if ((grp_cp_removal_Pipeline_cp_forward_fu_64_ap_done = ap_const_logic_0)) then 
    ...
    grp_cp_removal_Pipeline_cp_discard_fu_52_ap_start <= grp_cp_removal_Pipeline_cp_discard_fu_52_ap_start_reg;
    grp_cp_removal_Pipeline_cp_forward_fu_64_ap_start <= grp_cp_removal_Pipeline_cp_forward_fu_64_ap_start_reg;
    grp_cp_removal_Pipeline_cp_forward_fu_64_out_stream_TREADY <= (out_stream_TREADY_int_regslice and ap_CS_fsm_state6);
    in_stream_TREADY <= regslice_both_in_stream_V_data_V_U_ack_in;

    in_stream_TREADY_int_regslice_assign_proc : process(grp_cp_removal_Pipeline_cp_discard_fu_52_in_stream_TREADY, grp_cp_removal_Pipeline_cp_forward_fu_64_in_stream_TREADY, ap_CS_fsm_state3, ap_CS_fsm_state6)
    begin
    ...
    out_stream_TVALID_int_regslice <= grp_cp_removal_Pipeline_cp_forward_fu_64_out_stream_TVALID;
end behav;
