set moduleName cp_removal_Pipeline_cp_forward
set isTopModule 0
...
set C_modelName {cp_removal_Pipeline_cp_forward}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "cp_removal_Pipeline_cp_forward",
		"Protocol" : "ap_ctrl_hs",
