; ModuleID = '/home/samarth/Desktop/6g_ai_ran/cp_removal/cp_removal/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_cp_removal_ir(%"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* noalias nonnull dereferenceable(12) %in_stream, %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* noalias nonnull dereferenceable(12) %out_stream) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_cp_removal_hw(i32* %in_stream_copy.data, i4* %in_stream_copy.keep, i4* %in_stream_copy.strb, i1* %in_stream_copy.last, i32* %out_stream_copy.data, i4* %out_stream_copy.keep, i4* %out_stream_copy.strb, i1* %out_stream_copy.last)
...
declare void @apatb_cp_removal_hw(i32*, i4*, i4*, i1*, i32*, i4*, i4*, i1*)
...
define void @cp_removal_hw_stub_wrapper(i32*, i4*, i4*, i1*, i32*, i4*, i4*, i1*) #5 {
entry:
  ...
  call void @cp_removal_hw_stub(%"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* %8, %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* %9)
...
declare void @cp_removal_hw_stub(%"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* noalias nonnull, %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* noalias nonnull)
