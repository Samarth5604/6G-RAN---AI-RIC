; ModuleID = '/home/samarth/Desktop/6G-RAN---AI-RIC/6g_ai_ran/subcarrier_mapping/sc_mapping/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_sc_mapper_rx_ir(%"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* noalias nonnull "fpga.decayed.dim.hint"="2" %fft_in, %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* noalias nonnull "fpga.decayed.dim.hint"="2" %data_out) local_unnamed_addr #0 {
entry:
  ...
  %data_out_copy_0.data = alloca i32, align 512
  %data_out_copy_0.keep = alloca i4, align 512
  %data_out_copy_0.strb = alloca i4, align 512
  %data_out_copy_0.last = alloca i1, align 512
  %data_out_copy_1.data = alloca i32, align 512
  %data_out_copy_1.keep = alloca i4, align 512
  %data_out_copy_1.strb = alloca i4, align 512
  %data_out_copy_1.last = alloca i1, align 512
  ...
  %1 = bitcast %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* %data_out to [2 x %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"]*
  call void @copy_in([2 x %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"]* nonnull %0, i32* nonnull align 512 %fft_in_copy_0.data, i4* nonnull align 512 %fft_in_copy_0.keep, i4* nonnull align 512 %fft_in_copy_0.strb, i1* nonnull align 512 %fft_in_copy_0.last, i32* nonnull align 512 %fft_in_copy_1.data, i4* nonnull align 512 %fft_in_copy_1.keep, i4* nonnull align 512 %fft_in_copy_1.strb, i1* nonnull align 512 %fft_in_copy_1.last, [2 x %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"]* nonnull %1, i32* nonnull align 512 %data_out_copy_0.data, i4* nonnull align 512 %data_out_copy_0.keep, i4* nonnull align 512 %data_out_copy_0.strb, i1* nonnull align 512 %data_out_copy_0.last, i32* nonnull align 512 %data_out_copy_1.data, i4* nonnull align 512 %data_out_copy_1.keep, i4* nonnull align 512 %data_out_copy_1.strb, i1* nonnull align 512 %data_out_copy_1.last)
  call void @apatb_sc_mapper_rx_hw(i32* %fft_in_copy_0.data, i4* %fft_in_copy_0.keep, i4* %fft_in_copy_0.strb, i1* %fft_in_copy_0.last, i32* %fft_in_copy_1.data, i4* %fft_in_copy_1.keep, i4* %fft_in_copy_1.strb, i1* %fft_in_copy_1.last, i32* %data_out_copy_0.data, i4* %data_out_copy_0.keep, i4* %data_out_copy_0.strb, i1* %data_out_copy_0.last, i32* %data_out_copy_1.data, i4* %data_out_copy_1.keep, i4* %data_out_copy_1.strb, i1* %data_out_copy_1.last)
  call void @copy_back([2 x %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"]* %0, i32* %fft_in_copy_0.data, i4* %fft_in_copy_0.keep, i4* %fft_in_copy_0.strb, i1* %fft_in_copy_0.last, i32* %fft_in_copy_1.data, i4* %fft_in_copy_1.keep, i4* %fft_in_copy_1.strb, i1* %fft_in_copy_1.last, [2 x %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"]* %1, i32* %data_out_copy_0.data, i4* %data_out_copy_0.keep, i4* %data_out_copy_0.strb, i1* %data_out_copy_0.last, i32* %data_out_copy_1.data, i4* %data_out_copy_1.keep, i4* %data_out_copy_1.strb, i1* %data_out_copy_1.last)
  ret void
}
...
; Function Attrs: argmemonly noinline willreturn
define void @"arraycpy_hls.p0a2class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>.5.6"(%"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* "orig.arg.no"="0" "unpacked"="0.0" %dst_0, %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* "orig.arg.no"="0" "unpacked"="0.1" %dst_1, [2 x %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"]* "orig.arg.no"="1" %src, i64 "orig.arg.no"="2" %num) #1 {
entry:
  %0 = icmp eq [2 x %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"]* %src, null
...
; Function Attrs: argmemonly noinline willreturn
define internal void @copy_out([2 x %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"]* noalias "orig.arg.no"="0", i32* noalias align 512 "orig.arg.no"="1" "unpacked"="1.0.0" %_0_V_data_V, i4* noalias align 512 "orig.arg.no"="1" "unpacked"="1.0.1" %_0_V_keep_V, i4* noalias align 512 "orig.arg.no"="1" "unpacked"="1.0.2" %_0_V_strb_V, i1* noalias align 512 "orig.arg.no"="1" "unpacked"="1.0.3" %_0_V_last_V, i32* noalias align 512 "orig.arg.no"="1" "unpacked"="1.1.0" %_1_V_data_V, i4* noalias align 512 "orig.arg.no"="1" "unpacked"="1.1.1" %_1_V_keep_V, i4* noalias align 512 "orig.arg.no"="1" "unpacked"="1.1.2" %_1_V_strb_V, i1* noalias align 512 "orig.arg.no"="1" "unpacked"="1.1.3" %_1_V_last_V, [2 x %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"]* noalias "orig.arg.no"="2", i32* noalias align 512 "orig.arg.no"="3" "unpacked"="3.0.0" %_01_V_data_V, i4* noalias align 512 "orig.arg.no"="3" "unpacked"="3.0.1" %_01_V_keep_V, i4* noalias align 512 "orig.arg.no"="3" "unpacked"="3.0.2" %_01_V_strb_V, i1* noalias align 512 "orig.arg.no"="3" "unpacked"="3.0.3" %_01_V_last_V, i32* noalias align 512 "orig.arg.no"="3" "unpacked"="3.1.0" %_12_V_data_V, i4* noalias align 512 "orig.arg.no"="3" "unpacked"="3.1.1" %_12_V_keep_V, i4* noalias align 512 "orig.arg.no"="3" "unpacked"="3.1.2" %_12_V_strb_V, i1* noalias align 512 "orig.arg.no"="3" "unpacked"="3.1.3" %_12_V_last_V) #5 {
entry:
  call void @"onebyonecpy_hls.p0a2class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>.12.15"([2 x %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"]* %0, i32* align 512 %_0_V_data_V, i4* align 512 %_0_V_keep_V, i4* align 512 %_0_V_strb_V, i1* align 512 %_0_V_last_V, i32* align 512 %_1_V_data_V, i4* align 512 %_1_V_keep_V, i4* align 512 %_1_V_strb_V, i1* align 512 %_1_V_last_V)
  call void @"onebyonecpy_hls.p0a2class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>.12.15"([2 x %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"]* %1, i32* align 512 %_01_V_data_V, i4* align 512 %_01_V_keep_V, i4* align 512 %_01_V_strb_V, i1* align 512 %_01_V_last_V, i32* align 512 %_12_V_data_V, i4* align 512 %_12_V_keep_V, i4* align 512 %_12_V_strb_V, i1* align 512 %_12_V_last_V)
  ret void
}

; Function Attrs: argmemonly noinline willreturn
define void @"arraycpy_hls.p0a2class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>.13.14.23"([2 x %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"]* "orig.arg.no"="0" %dst, %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* "orig.arg.no"="1" "unpacked"="1.0" %src_0, i32* "orig.arg.no"="1" "unpacked"="1.1.0" %src_1_V_data_V, i4* "orig.arg.no"="1" "unpacked"="1.1.1" %src_1_V_keep_V, i4* "orig.arg.no"="1" "unpacked"="1.1.2" %src_1_V_strb_V, i1* "orig.arg.no"="1" "unpacked"="1.1.3" %src_1_V_last_V, i64 "orig.arg.no"="2" %num) #1 {
entry:
  %0 = icmp eq %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* %src_0, null
  %1 = icmp eq [2 x %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"]* %dst, null
  %2 = or i1 %1, %0
...
src.addr.case.1:                                  ; preds = %for.loop
  %3 = icmp eq i64 %for.loop.idx2, 1
  call void @llvm.assume(i1 %3)
  call void @"streamcpy_hls.p0class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>.26"(%"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* %dst.addr, i32* %src_1_V_data_V, i4* %src_1_V_keep_V, i4* %src_1_V_strb_V, i1* %src_1_V_last_V)
  br label %src.addr.exit
...
; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @"streamcpy_hls.p0class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>.26"(%"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* nocapture, i32* nocapture "unpacked"="1.0" %_V_data_V, i4* nocapture "unpacked"="1.1" %_V_keep_V, i4* nocapture "unpacked"="1.2" %_V_strb_V, i1* nocapture "unpacked"="1.3" %_V_last_V) unnamed_addr #2 {
entry:
  %1 = alloca i32
  %2 = alloca i4
  %3 = alloca i4
...
; Function Attrs: argmemonly noinline willreturn
define void @"arraycpy_hls.p0a2class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>.5.6.34"(%"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* "orig.arg.no"="0" "unpacked"="0.0" %dst_0, i32* "orig.arg.no"="0" "unpacked"="0.1.0" %dst_1_V_data_V, i4* "orig.arg.no"="0" "unpacked"="0.1.1" %dst_1_V_keep_V, i4* "orig.arg.no"="0" "unpacked"="0.1.2" %dst_1_V_strb_V, i1* "orig.arg.no"="0" "unpacked"="0.1.3" %dst_1_V_last_V, [2 x %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"]* "orig.arg.no"="1" %src, i64 "orig.arg.no"="2" %num) #1 {
entry:
  %0 = icmp eq [2 x %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"]* %src, null
  %1 = icmp eq %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* %dst_0, null
  %2 = or i1 %1, %0
...
; Function Attrs: argmemonly noinline willreturn
define internal void @"onebyonecpy_hls.p0a2class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>.12.15"([2 x %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"]* noalias "orig.arg.no"="0" %dst, i32* noalias align 512 "orig.arg.no"="1" "unpacked"="1.0.0" %src_0_V_data_V, i4* noalias align 512 "orig.arg.no"="1" "unpacked"="1.0.1" %src_0_V_keep_V, i4* noalias align 512 "orig.arg.no"="1" "unpacked"="1.0.2" %src_0_V_strb_V, i1* noalias align 512 "orig.arg.no"="1" "unpacked"="1.0.3" %src_0_V_last_V, i32* noalias align 512 "orig.arg.no"="1" "unpacked"="1.1.0" %src_1_V_data_V, i4* noalias align 512 "orig.arg.no"="1" "unpacked"="1.1.1" %src_1_V_keep_V, i4* noalias align 512 "orig.arg.no"="1" "unpacked"="1.1.2" %src_1_V_strb_V, i1* noalias align 512 "orig.arg.no"="1" "unpacked"="1.1.3" %src_1_V_last_V) #6 {
entry:
  %0 = icmp eq [2 x %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"]* %dst, null
  br i1 %0, label %ret, label %copy

copy:                                             ; preds = %entry
  call void @"arraycpy_hls.p0a2class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>.13.14.23.52"([2 x %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"]* nonnull %dst, i32* %src_0_V_data_V, i4* %src_0_V_keep_V, i4* %src_0_V_strb_V, i1* %src_0_V_last_V, i32* %src_1_V_data_V, i4* %src_1_V_keep_V, i4* %src_1_V_strb_V, i1* %src_1_V_last_V, i64 2)
  br label %ret
...
; Function Attrs: argmemonly noinline willreturn
define void @"arraycpy_hls.p0a2class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>.13.14.23.52"([2 x %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"]* "orig.arg.no"="0" %dst, i32* "orig.arg.no"="1" "unpacked"="1.0.0" %src_0_V_data_V, i4* "orig.arg.no"="1" "unpacked"="1.0.1" %src_0_V_keep_V, i4* "orig.arg.no"="1" "unpacked"="1.0.2" %src_0_V_strb_V, i1* "orig.arg.no"="1" "unpacked"="1.0.3" %src_0_V_last_V, i32* "orig.arg.no"="1" "unpacked"="1.1.0" %src_1_V_data_V, i4* "orig.arg.no"="1" "unpacked"="1.1.1" %src_1_V_keep_V, i4* "orig.arg.no"="1" "unpacked"="1.1.2" %src_1_V_strb_V, i1* "orig.arg.no"="1" "unpacked"="1.1.3" %src_1_V_last_V, i64 "orig.arg.no"="2" %num) #1 {
entry:
  %0 = icmp eq [2 x %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"]* %dst, null
  br i1 %0, label %ret, label %copy
...
src.addr.case.0:                                  ; preds = %for.loop
  call void @"streamcpy_hls.p0class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>.26"(%"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* %dst.addr, i32* %src_0_V_data_V, i4* %src_0_V_keep_V, i4* %src_0_V_strb_V, i1* %src_0_V_last_V)
  br label %src.addr.exit
...
declare void @apatb_sc_mapper_rx_hw(i32*, i4*, i4*, i1*, i32*, i4*, i4*, i1*, i32*, i4*, i4*, i1*, i32*, i4*, i4*, i1*)
...
define void @sc_mapper_rx_hw_stub_wrapper(i32*, i4*, i4*, i1*, i32*, i4*, i4*, i1*, i32*, i4*, i4*, i1*, i32*, i4*, i4*, i1*) #7 {
entry:
  %16 = alloca [2 x %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"]
  %17 = alloca [2 x %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"]
  call void @copy_out([2 x %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"]* %16, i32* %0, i4* %1, i4* %2, i1* %3, i32* %4, i4* %5, i4* %6, i1* %7, [2 x %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"]* %17, i32* %8, i4* %9, i4* %10, i1* %11, i32* %12, i4* %13, i4* %14, i1* %15)
  %18 = bitcast [2 x %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"]* %16 to %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"*
  %19 = bitcast [2 x %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"]* %17 to %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"*
  call void @sc_mapper_rx_hw_stub(%"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* %18, %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* %19)
  call void @copy_in([2 x %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"]* %16, i32* %0, i4* %1, i4* %2, i1* %3, i32* %4, i4* %5, i4* %6, i1* %7, [2 x %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"]* %17, i32* %8, i4* %9, i4* %10, i1* %11, i32* %12, i4* %13, i4* %14, i1* %15)
  ret void
}

declare void @sc_mapper_rx_hw_stub(%"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* noalias nonnull, %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* noalias nonnull)
